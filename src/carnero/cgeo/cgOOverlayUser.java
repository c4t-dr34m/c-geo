...
public class cgOOverlayUser extends OverlayItem {
	private Context context = null;
	private cgUser user = null;

	public cgOOverlayUser(Context contextIn, cgUser userIn) {
		super(userIn.username, "", new GeoPoint((int)(userIn.latitude * 1e6), (int)(userIn.longitude * 1e6)));
